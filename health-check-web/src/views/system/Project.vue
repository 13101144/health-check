<template>
	<section>
		...
		<el-table :data="projects" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="code" label="项目代码" width="300" sortable>
			</el-table-column>
			<el-table-column prop="owner" label="拥有者" width="150" sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="拥有者">
					<el-input type="textarea" v-model="editForm.owner" :min="0" :max="200"></el-input>
				</el-form-item>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="拥有者">
					<el-input type="textarea" v-model="addForm.owner" :min="0" :max="200"></el-input>
				</el-form-item>
				<el-form-item label="描述">
