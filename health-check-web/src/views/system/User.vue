	...
	<section>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="昵称">
					<el-input type="textarea" v-model="editForm.nickname" :min="0" :max="200"></el-input>
				</el-form-item>
				<el-form-item label="电话">
					<el-input type="textarea" v-model="editForm.phone" :min="0" :max="200"></el-input>
				</el-form-item>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="昵称">
					<el-input type="textarea" v-model="addForm.nickname" :min="0" :max="200"></el-input>
				</el-form-item>
				<el-form-item label="电话">
					<el-input type="textarea" v-model="addForm.phone" :min="0" :max="200"></el-input>
				</el-form-item>
				<el-form-item label="邮箱">
